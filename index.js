...
async function fetchImage(outline, name){
  const response = await openai.createImage({
    prompt: `Create a character portrait for ${outline} with name ${name}. The portrait should have an appropriate background and artstyle. Keep in mind the genre, setting.`,
    n: 1,
    size : '256x256',
